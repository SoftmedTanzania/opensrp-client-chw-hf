...
public class LdEmergencyReferralRegistrationActivity extends BaseIssueReferralActivity {
    ...
    public static void startGeneralReferralFormActivityForResults(Activity activity, String baseEntityID, JSONObject formJsonObject, boolean useCustomLayout) {
        ...
        Intent intent = new Intent(activity, LdEmergencyReferralRegistrationActivity.class);
